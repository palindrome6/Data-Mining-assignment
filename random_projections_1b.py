...
p = input("Enter the number of test samples")
q = input("Enter the number of training samples")
...
for m in test:
    for n in training:
        cossim[index1] = spatial.distance.euclidean(m[0],n[0]) #  calculates cosine similarity
